...
/// `dst &= src`.
#[inline]
pub(crate) fn and(dst: &mut Bitmap, src: &Bitmap) {
    #[cfg(target_arch = "x86_64")]
    unsafe {
...
#[inline]
pub(crate) fn and_count(dst: &mut Bitmap, src: &Bitmap) -> u32 {
    #[cfg(target_arch = "x86_64")]
    unsafe {
    ...
    #[cfg(target_arch = "aarch64")]
    unsafe {
        return super::fold_count_neon(dst, src, |a, b| std::arch::aarch64::vandq_u64(a, b));
    }
    #[allow(unreachable_code)]
